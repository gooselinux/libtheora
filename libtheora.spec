...
# padsp wrapper
mv $RPM_BUILD_ROOT%{_bindir}/theora_player{,.bin}
...
%changelog
* Thu Jun 24 2010 Adam Jackson <ajax@redhat.com> 1.1.0-2
- padsp wrapper script for theora_player (#596728)
